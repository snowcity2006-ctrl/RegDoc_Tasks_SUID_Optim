...
const api: ElectronAPI = {
  ...
  // Работа в СУИД
  getSuidTasks: () => ipcRenderer.invoke('suid:getAll'),
  getSuidTaskById: (id) => ipcRenderer.invoke('suid:getById', id),
  saveSuidTask: (task) => ipcRenderer.invoke('suid:save', task),
  saveSuidTasks: (tasks) => ipcRenderer.invoke('suid:saveTasks', tasks),
  deleteSuidTask: (id) => ipcRenderer.invoke('suid:delete', id),
