        ...
        >
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p id="doctype-modal-subtitle" className="text-[11px] text-blue-100 truncate">
            ...
            <div className="p-3 bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800/60 rounded-xl text-xs text-amber-800 dark:text-amber-300 flex items-start gap-2.5 animate-in fade-in">
              ...
              <div>
                ...
                <p className="mt-0.5 text-[11px] text-amber-900/90 dark:text-amber-200/90 leading-relaxed">
                  Запись с наименованием «<strong className="text-amber-950 dark:text-amber-100">{duplicateType?.name}</strong>» (ID: #{duplicateType?.id}) уже есть в справочнике. Повторное создание запрещено.
                </p>
              </div>
            </div>
          )}
                ...
                <div className="flex flex-wrap gap-1.5 max-h-36 overflow-y-auto pr-1">
                  {existingTypes.map((t) => {
                    ...
                    return (
                      ...
                      >
                        <span>{t.name}</span>
                        <span className="text-[10px] text-slate-400 dark:text-gray-500">#{t.id}</span>
                      </span>
                    );
                  })}
                </div>
